...
.EXAMPLE
  powershell -File scripts\github\switch_dev.ps1

.EXAMPLE
  powershell -File scripts\github\switch_dev.ps1 -BranchName feature/new-chart

.EXAMPLE
  powershell -File scripts\github\switch_dev.ps1 -Sync
#>
...
Write-Section "Switch to Development Branch"
