...
import 'package:gait_charts/features/dashboard/presentation/widgets/analysis/stage_details_section.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final dataSection = AsyncRequestView<StageDurationsResponse>(
      ...
      dataBuilder: (context, response) => StageAnalyticsContent(
        ...
        onVideoSeek: (seconds) {
          // 透過 provider 發送跳轉請求，VideoPlaybackView 會監聽並執行
          ref.read(videoSeekRequestProvider.notifier).request(seconds);
          // 切換到影片播放頁面
