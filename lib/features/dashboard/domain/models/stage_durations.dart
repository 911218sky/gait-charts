...
class LapSummary {
  ...
  final String lapDirection; // 圈數方向：clockwise/counterclockwise/unknown
  final List<StageDurationStage> stages; // 該圈內的各階段資料

  /// 是否為順時針方向。
  bool get isClockwise => lapDirection == 'clockwise';

  /// 是否為逆時針方向。
  bool get isCounterclockwise => lapDirection == 'counterclockwise';
  ...
  factory LapSummary.fromJson(Map<String, dynamic> json) {
    ...
    return LapSummary(
      ...
      lapDirection: _stringValue(json['lap_direction']),
